<?php
/**
 * The template for displaying all single programs posts
 * alfairoze theme
 */
...
<div class="section">
        ...
        while ( have_posts() ) : the_post();?> 
              <div class="program">
                ...
                <a class="button" href="#ert">اشترك الان</a>
              </div>
            </div>
            <?php
        // End the loop.
      ...
      <div id='ert' class="section">
        <div class="component type--block theme--appointment">
          <div class="block__header">
            <div class="block__title">اشترك فى البرنامج</div>
          </div>
          <div class="block__main">
          <?php echo do_shortcode( '[contact-form-7 id="146" title="اشترك فى البرنامج الواحد"]' ); ?>
          </div>
        </div>
      </div>
<?php get_footer();?>